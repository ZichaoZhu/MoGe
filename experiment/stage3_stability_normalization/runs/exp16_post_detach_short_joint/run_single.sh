...
EXP_DIR="$REPO/experiment/stage3_stability_normalization/runs/exp16_post_detach_short_joint"
EXP15_DIR="$REPO/experiment/stage2_training_strategy/runs/exp15_detached_head_ssr_coadaptation"
